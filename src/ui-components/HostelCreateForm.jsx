...
export default function HostelCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setHostelName(initialValues.hostelName);
    setAddress(initialValues.address);
    setStreet(initialValues.street);
    setBuilding(initialValues.building);
    setErrors({});
  };
  const validations = {
    lat: [{ type: "Required" }],
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new Hostel(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "HostelCreateForm")}
      {...rest}
    >
      <TextField
        label="Lat"
